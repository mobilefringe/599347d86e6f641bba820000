<template>
    <div class="home_page_container">
        ...
        <div class="home_map">
            <iframe title="Map" width="100%" height="480" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"  :src="'http://maps.google.nl/maps?q='+property.address1  +'&amp;hl=en&amp;ie=UTF8&amp;t=v&amp;hnear='+property.address1  +'&amp;z=13&amp;output=embed'">
            <!--property.city property.country property.province_state property.province_state -->
            <!--property.city property.country property.province_state property.province_state-->
                    Map
                </iframe>
        </div>
    ...
    return Vue.component("home-component", {
      ...
      data: function() {
        return {
          ...
          full_address: this.property.address1 +''+this.property.city +''+ this.property.country +''+this.property.province_state +''+this.property.province_state
        }
      },
      mounted () {
          this.feature_items;
