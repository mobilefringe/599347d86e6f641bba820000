    ...
    <div class="page_container" id="store_detail_container">
        ...
        <div class="row is-table-row padding_tb_50" v-if="currentStore && currentStore.total_published_promos > 0">
            <div class="col-md-6" style="vertical-align:top;" v-for="promo in promotions">
                <div class="col-md-6"> <img :src="currentStore.promo_image_url_abs" class="store_logo" alt=""> </div>
                <div class="col-md-6"> <p class="description_text text_left">{{currentStore.description}}</p> </div>
        ...
        return Vue.component("store-details-component", {
            ...
            watch : {
                ...
                currentStore : function (){
                    console.log("currentStore this",this);
                    var vm = this;
                    var temp = [];
