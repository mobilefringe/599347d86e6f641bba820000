            ...
            <div class="stores_container">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="alphabet-dd visible_phone" >
					    <v-select :options="filteredStores" label="name" :searchable="false" :on-change="addLandmark" id="mobile_alpha_list" :placeholder="$t('stores_page.select_a_store')"></v-select>
				    </div>
